...
type AnalyticsSubTab = 'plan_fact' | 'by_staff'

const SUB_TABS: PageTab<AnalyticsSubTab>[] = [
  { id: 'plan_fact', labelKey: 'inventory.analytics.plan_fact_title', icon: BarChart3 },
  { id: 'by_staff', labelKey: 'inventory.analytics.staff_title', icon: Users },
]
...
export function InventoryAnalyticsTab({ salonId, currency }: Props) {
  ...
  const [subTab, setSubTab] = useState<AnalyticsSubTab>('plan_fact')
  ...
  return (
    <div className="flex flex-col gap-5">
      <PageTabsNav tabs={SUB_TABS} active={subTab} onChange={setSubTab} t={t} />
