...
<p style="margin:0 0 16px 0; font-size:16px; line-height:24px; color:#334155;">
Если будут вопросы или что-то будет работать не так — пиши мне напрямую на <a href="mailto:support@finkley.app" style="color:#10b981; text-decoration:none;">support@finkley.app</a>. Отвечаю лично.
</p>
...
Это транзакционное письмо. Если у тебя есть вопросы по обработке данных — privacy@finkley.app
</p>
...
{{owner_name}}<br>
<span style="color:#64748b; font-size:14px;">support@finkley.app</span>
</p>
...
<p style="margin:0 0 16px 0; font-size:14px; line-height:22px; color:#64748b;">
Вопросы — пиши на <a href="mailto:support@finkley.app" style="color:#10b981; text-decoration:none;">support@finkley.app</a>.
</p>
...
<p style="margin:32px 0 16px 0; font-size:14px; line-height:22px; color:#64748b;">
Расскажи, почему отказалась? Один абзац очень помог бы сделать продукт лучше: <a href="mailto:support@finkley.app" style="color:#10b981; text-decoration:none;">support@finkley.app</a>
</p>
