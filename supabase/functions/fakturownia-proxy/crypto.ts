/**
 * AES-256-GCM шифрование Fakturownia api_token (см. ADR-013 §C).
 * Идентично паттерну wfirma-proxy/crypto.ts, отдельный ключ FAKTUROWNIA_SECRETS_KEY
 * для изоляции compromise.
 */

const KEY_NAME = 'FAKTUROWNIA_SECRETS_KEY'
